...
public class Assignment_Pattern3 {
    public static void main(String[] args) {
        ...
        for (outerLoop = 0; outerLoop < loopRange; outerLoop++) {
            ...
            for (innerLoop = 0; innerLoop < loopRange; innerLoop++) {
                ...
                if (outerLoop == 0 || innerLoop == 0 || outerLoop == loopRange-1 || innerLoop == loopRange-1 || outerLoop+innerLoop <= (loopRange-1)/2 || innerLoop-outerLoop >= (loopRange-1)/2) {
                    System.out.print("*");
                }
                else
                    System.out.print(" ");
