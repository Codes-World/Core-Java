...
public class Assiignment_Patter4 {
    public static void main(String[] args) {
        ...
        for (outerLoop = 0; outerLoop < loopRange; outerLoop++) {
            ...
            for (innerLoop = 0; innerLoop < loopRange; innerLoop++) {
                ...
                //This is the logic of "P"...
                if (outerLoop == 0 && innerLoop < loopRange-1 || innerLoop == 0 || outerLoop == (loopRange-1)/2 && innerLoop < loopRange-1 || innerLoop == loopRange-1 && outerLoop > 0 && outerLoop < (loopRange-1)/2) {
                    System.out.print("*");
                }
                else
                    System.out.print(" ");
            ...
            for (innerLoop = 0; innerLoop < loopRange; innerLoop++) {
                ...
                //This is the logic of "W"...
                if (innerLoop == 0 || innerLoop == loopRange - 1 || (outerLoop >= loopRange / 2 && (innerLoop == outerLoop || innerLoop == loopRange - 1 - outerLoop))) {
                    System.out.print("*");
                }
                else
                    System.out.print(" ");
            ...
            for (innerLoop = 0; innerLoop < loopRange; innerLoop++) {
                ...
                //This is the logic of "L"...
                if (innerLoop == 0 || outerLoop == loopRange-1) {
                    System.out.print("*");
                }
                else
                    System.out.print(" ");
